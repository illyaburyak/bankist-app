...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-03-31T17:01:17.194Z',
    '2021-04-02T23:36:17.929Z',
    '2021-04-04T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'en-GB', // de-DE
};
...
const formstMovementsDate = function (date, locale) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, index) {
    ...
    const displayDate = formstMovementsDate(date, acc.locale);
